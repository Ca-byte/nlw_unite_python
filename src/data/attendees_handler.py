...
class AttendeesHandler:
    ...
    def registry(self, http_request: HttpRequest) -> HttpResponse:
        ...
        ): raise HttpConflictError("Event limited")
    ...
    def find_attendee_badge(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if not badge: raise HttpNotFoundError("Participant is not found!")
    ...
    def find_attendees_from_event(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if not attendees: raise HttpNotFoundError("Participant are not found!")
